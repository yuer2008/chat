...
use app\assets\YxiaoAsset;

YxiaoAsset::register($this);
?>
<?php $this->beginPage() ?>
<!DOCTYPE html>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown menu-merge">
          <a href="#" class="dropdown-toggle fw600 p15" data-toggle="dropdown">
            <img src="Import/img/avatars/1.jpg" alt="avatar" class="mw30 br64">
      ...
      <div class="sidebar-left-content nano-content">
          ...
          <div class="sidebar-widget author-widget">
            <div class="media">
              <a class="media-left" href="#">
                <img src="Import/img/avatars/3.jpg" class="img-responsive">
              </a>
              <div class="media-body">
        ...
        <ul class="nav sidebar-menu">
          <li class="sidebar-label pt20">Menu</li>
            ...
            <?php
            /*if($this->params["id"]==$this->context->action->id){
                $css    =   "class=\"active\" ";
            }else{
                $css    =   "";
            }*/
          ...
          <li>
            ...
            <ul class="nav sub-nav">
              <li>
                <a href="index.php?r=mber/for72h">
                  <span class="glyphicon glyphicon-shopping-cart"></span>72H's注册的</a>
              </li>
              <li>
                <a href="index.php?r=mber/cao3ms">
                  <span class="glyphicon glyphicon-calendar"></span>超3个月未登录的</a>
              </li>
              <li>
                <a href="index.php?r=mber/alllist">
                  <span class="glyphicon glyphicon-calendar"></span>全部列表</a>
              </li>              
              <li>
                <a href="index.php?r=mber/loginset">
          ...
          <li>
            ...
            <ul class="nav sub-nav">
              <li>
                <a href="index.php?r=yxiao/category">
                  <span class="glyphicon glyphicon-shopping-cart"></span>音效分类</a>
              </li>
              <li>
                <a href="index.php?r=yxiao/for24h">
                  <span class="glyphicon glyphicon-calendar"></span>24H's最新音效</a>
              </li>
              <li>
                <a href="index.php?r=yxiao/alllist">
                  <span class="glyphicon glyphicon-calendar"></span>音效列表</a>
              </li>              
              <li>
                <a href="index.php?r=yxiao/shenqin">
                  <span class="fa fa-desktop"></span> 音效师申请 </a>
              </li>
              <li>
                <a href="index.php?r=yxiao/yxiaoer">
                  <span class="fa fa-clipboard"></span> 音效师 </a>
              </li>
             <li>
                <a href="index.php?r=yxiao/pinlun">
                  <span class="fa fa-clipboard"></span> 评论信息 </a>
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul class="nav sub-nav">
              <li>
                <a href="index.php?r=system/quanju">
                  <span class="glyphicon glyphicon-shopping-cart"></span>全局变量</a>
              </li>
              <li>
                <a href="index.php?r=system/keysku">
