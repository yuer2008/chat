                  ...
                  <table class="table table-striped table-hover" id="datatable3" cellspacing="0" width="100%">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><span class="suid"><?php echo $yx['er_uid'];?></span></td>
                        <td><?php echo getNick($yx['er_uid']);?></td>
                        <td><?php echo date("Y-m-d H:i:s", strtotime("+8 hours", $yx['er_jointime']));?></td>
                        <td><i class="fa fa-times sqin"></i></td>
                      </tr>
                      <?php }?>
                    </tbody>
                  </table>
