      ...
      <header id="topbar" class="alt">
        <div class="topbar-left">
          <ol class="breadcrumb">
            ...
            <li class="crumb-trail">会员登录痕迹</li>
          </ol>
        </div>
      </header>
      <!-- End: Topbar -->
                  ...
                  <table class="table table-striped table-hover" id="datatable3" cellspacing="0" width="100%">
                    <thead>
                      <tr >
                        ...
                        <th width="110">当次请求</th>
                        <th width="110">所用设备</th>
                      </tr>
                    </thead>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <?php $uid = $yx['uid'];?>
                        <td><?php echo getHhjj($uid);?></td>
                        <td><?php echo getNick($uid);?></td>
                        <td><?php echo date("Y-m-d H:i:s", strtotime("+8 Hours", $yx['logintime']));?></td>

                        <td>
                          <?php echo $yx['logouttime']?date("Y-m-d H:i:s", strtotime("+8 Hours", $yx['logouttime'])):"-";?>
                        </td>
                        <td><?php echo $yx['onlinetime'];?> s</td>
                        <td><?php echo $yx['ip'];?></td>

                        <td><?php echo $yx['sessionid'];?></td>

                        <td><?php echo $yx['device'];?></td>
                      </tr>
                      <?php }?>
                    </tbody>
                  </table>
