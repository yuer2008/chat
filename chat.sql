...
CREATE TABLE `chat_room` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='room±í';
...
CREATE TABLE `chat_users` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'idä¸»é”®',
...
INSERT INTO `chat_users` VALUES (2,'yangfutao');
...
-- Dump completed on 2017-11-03 17:57:50
